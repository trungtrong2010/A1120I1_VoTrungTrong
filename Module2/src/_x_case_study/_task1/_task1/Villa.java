...
public class Villa extends Services {
    ...
    private int areaHoBoi;
    private int soTang;

    public Villa(String nameServices, int area, int money, int peopleMax, String rentalType, String id, String dvPlus,
                 String tieuChuanPhong, String paintedTienNghi, int areaHoBoi, int soTang) {
    ...
    public int getAreaHoBoi() {
        return areaHoBoi;
    }

    public void setAreaHoBoi(int areaHoBoi) {
        this.areaHoBoi = areaHoBoi;
    }
